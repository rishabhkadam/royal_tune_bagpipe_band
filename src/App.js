...
function App() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Royal Bagpipe Academy | Best Bagpipe Band and Training Academy in
          India
        </title>
        <meta
          name="description"
      ...
      <Routes>
        ...
        {/* Event Booking Page */}
        <Route path="/hire-bagpiper-india" element={<EventBooking />} />
      </Routes>
      <Contact />
      <Footer />
    </>
